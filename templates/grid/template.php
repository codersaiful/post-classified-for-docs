...
$columns = isset( $this->atts['columns'] ) ? absint( $this->atts['columns'] ) : 3;
$columns = max( 1, min( 4, $columns ) ); // Limit between 1-4
?>
<div class="bizzdocmaker-wrapper bizzdocmaker-grid" style="--grid-columns: <?php echo esc_attr( $columns ); ?>;">
